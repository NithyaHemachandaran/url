...
function Signup() {
  ...
  return (
   ...
   <div className=" border border-dark rounded-4 bg-light p-5 mt-3 col-lg-6 bg-g">
       ...
       <form onSubmit={handleSubmit}>
           ...
           <br></br>
           <input type="text" onChange={(e) => setFname(e.target.value)} placeholder="Enter FirstName" required></input>
           </div>
           <div className="my-3">
           {/* <label>
               Enter Last Name:
           ...
           <br></br>
           <input type="text" onChange={(e) => setLname(e.target.value)}  placeholder="Enter LastName"  required></input>
           </div>
           <div className="my-2">
           {/* <label>
               Enter Password:
           ...
           <br></br>
           <input type="password" onChange={(e) => setPwd(e.target.value)} placeholder="Enter Password"  required></input>
           </div>
           <button type="submit" className="btn btn-sm btn-secondary mt-3">Sign up</button>
       </form>
